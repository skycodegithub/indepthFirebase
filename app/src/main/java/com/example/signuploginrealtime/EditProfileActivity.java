...
public class EditProfileActivity extends AppCompatActivity {
    ...
    public boolean isEmailChanged() {
        if (!emailUser.equals(editName.getText().toString())) {
            reference.child(usernameUser).child("name").setValue(editEmail.getText().toString());
    ...
    public boolean isPasswordChanged() {
        if (!nameUser.equals(editPassword.getText().toString())) {
            reference.child(usernameUser).child("name").setValue(editPassword.getText().toString());
